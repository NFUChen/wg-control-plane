  ...
  template: `
    ...
    >
      ...
      >
        ...
        <!-- Modal Footer -->
        <div *ngIf="hasFooter" class="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/80 rounded-b-lg">
          <ng-content select="[slot=footer]"></ng-content>

          <!-- Default buttons if no custom footer provided -->
